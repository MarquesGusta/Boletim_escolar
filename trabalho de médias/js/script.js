function calcularMedia(){
    ...
    if(media1 < media_geral){
        document.getElementById("media_abaixo1").innerHTML = nome1
    }

    if(media2 < media_geral){
        document.getElementById("media_abaixo2").innerHTML = nome2
    }

    if(media3 < media_geral){
        document.getElementById("media_abaixo3").innerHTML = nome3
    }

    if(media4 < media_geral){
        document.getElementById("media_abaixo4").innerHTML = nome4
    }

    if(media5 < media_geral){
        document.getElementById("media_abaixo5").innerHTML = nome5
    }
}